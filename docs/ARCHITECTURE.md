...
- **Hidden URL Routing**: Navigating to `/<LIST_NAME>` or `/<LIST_NAME>/<INDEX>` overrides the random selection. It forces the loading of a specific sentence list (and optionally a specific index) and skips the initial 30s initial delay.
